...
function AboutUs() {
    return (
        <div id="container" className="container">
            <div id="navSimulator" className="row"></div>
            <div className="row justify-content-center align-items-center w-100 fontControl py-3 text-center">
            ...
            <div id="imgContainer" className="row justify-content-center align-items-center h-50 w-100">
