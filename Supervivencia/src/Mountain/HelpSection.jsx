...
function HelpSection({ cancelGame }) {
    ...
    return (
        <div className="position-absolute z-1 bg-white border border-black rounded p-3 mb-5 appear-animation w-75 h-75 d-flex flex-column justify-content-center align-items-center top-50 start-50 translate-middle " style={{ maxWidth: '600px' }}>
            ...
            <span id="bagTutorialText" tabIndex="0" className="text-center " ref={ref1} style={{ fontSize: fontSize1, height: '60%', width: '100%', letterSpacing: '1.4px', lineHeight: '1.3' }}>
            En este juego de memoria, empareja imágenes de seres vivos con sus huellas.<br></br> El color del borde de cada huella coincide con el color del borde del animal asociado.<br></br> Si eliges el modo fácil podrás voltear las cartas sin tiempo límite con el botón <span style={{ fontWeight: 'bold' }}>Volver a Intentar</span>.
            </span>
