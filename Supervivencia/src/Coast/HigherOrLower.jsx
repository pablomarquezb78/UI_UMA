...
function HigherLowerGame() {
    ...
    return (
        <><section className='gameHOL d-flex flex-column justify-content-center align-items-center text-center vh-100 vw-100'>
        ...
        </div><section className='imagenesHOL position-relative d-flex justify-content-center align-items-center'>
            ...
            </section><div className="d-flex justify-content-center align-items-center">
